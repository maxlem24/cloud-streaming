...
class FlutterFlowTheme {
  ...
  Color get bg         => const Color(0xFF0B0B0E);
  Color get surface    => const Color(0xFF1A1030);
  Color get surfaceAlt => const Color(0xFF2A2A40);
  Color get primary    => const Color(0xADFF2DAC);
  Color get secondary  => const Color(0xFF7F5AF0);
  Color get accent     => const Color(0xFFA6C6DA);
