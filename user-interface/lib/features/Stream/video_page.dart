...
class _VideoPageState extends State<VideoPage> {
  ...
  Future<void> _initMqtt() async {
    ...
    try {
      ...
      // await _mqtt.initAndConnect(); todo
                                  ...
                                  return VideoCard(
                                    ...
                                    onTap: () {
                                      ...
                                      try {
                                        ...
                                        print(brokerParts);
                                        const broker = '172.20.10.4';
                                        const port = 1883;
                                        final topicMain = "live/watch/$brokerParts/";
                                        final topic = topicMain+v.id;
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => LiveViewerPage(videoId:v.id ),
                                          ),
                                        );
                                      } catch (e) {
                                        ScaffoldMessenger.of(context).showSnackBar(
